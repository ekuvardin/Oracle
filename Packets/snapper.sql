...
--
--
-- Thanks to:   Adrian Billington, Jamey Johnston, Marcus Monnig, Hans-Peter Sloot,
...
begin
    ...
    if pagesize > 0 then
        output(' ');
        output('-- Session Snapper v4.22 - by Tanel Poder ( http://blog.tanelpoder.com/snapper ) - Enjoy the Most Advanced Oracle Troubleshooting Script on the Planet! :)');
        output(' ');
    end if;
