...
-- Redefines a table by adding new columns and adding partitioning
	, col_mapping  => 'ID ID'
		||', SN SN'
		||', SU SU'
		||', case when C_DATE_CR < TO_DATE(''01/01/2012'', ''DD/MM/YYYY'') then 0'
			||	' when C_DATE_CR < TO_DATE(''01/01/2013'', ''DD/MM/YYYY'') then 1 else 1000 end KEY'
		||', C_DATE_CR C_DATE_CR'
		||', C_X C_X'
		||', C_Y C_Y'
		||', C_VAL C_VAL'
...
insert into Z#ADE_PART4TST a1 ( SN,SU, ID, C_X, C_Y, C_VAL, C_DATE_CR )
	values (1,4008160,SEQ_ID.NEXTVAL,11, 1001, dbms_random.random, to_date('02/12/2011','DD/MM/YYYY'));

insert into Z#ADE_PART4TST a1 ( SN,SU, ID, C_X, C_Y, C_VAL, C_DATE_CR )
	values (1,4008160,SEQ_ID.NEXTVAL,11, 1001, dbms_random.random, to_date('28/04/2012','DD/MM/YYYY'));

insert into Z#ADE_PART4TST a1 ( SN,SU, ID, C_X, C_Y, C_VAL, C_DATE_CR )
	values (1,4008160,SEQ_ID.NEXTVAL,11, 1001, dbms_random.random, to_date('21/09/2013','DD/MM/YYYY'));

insert into Z#ADE_PART4TST a1 ( SN,SU, ID, C_X, C_Y, C_VAL, C_DATE_CR )
	values (1,4008160,SEQ_ID.NEXTVAL,11, 1001, dbms_random.random, to_date('10/12/2013','DD/MM/YYYY'));
...
ALTER TABLE par_table ADD ( CONSTRAINT PK_Z#ADE_PART4TST_ID2 PRIMARY KEY (id, key) ); 

CREATE INDEX IDX_Z#ADE_PART4TST_DATE_CR2 ON par_table(C_DATE_CR);
...
-------------------------------------------------------------------------------------------
ALTER TABLE Z#ADE_PART4TST RENAME CONSTRAINT PK_Z#ADE_PART4TST_ID2 TO PK_Z#ADE_PART4TST_ID; 
ALTER INDEX IDX_Z#ADE_PART4TST_DATE_CR2 RENAME TO IDX_Z#ADE_PART4TST_DATE_CR;
